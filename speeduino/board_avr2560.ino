...
void initBoard()
{
    ...
    */
    ...
    TCCR1A = TIMER_MODE_FASTPWM;     //Timer1 Control Reg A: Wave Gen Mode normal (Simply counts up from 0 to 65535 (16-bit int)
    ...
    * */
    ...
    TCCR5A = TIMER_MODE_PWM;     //Timer5 Control Reg A: Wave Gen Mode normal
