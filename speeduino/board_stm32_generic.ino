...
void initBoard()
{
    ...
    */
    ...
    vvt_pwm_max_count = 1000000L / (TIMER_RESOLUTION * configPage6.dbwFreq * 2); //Converts the frequency in Hz to the number of ticks (at 2uS) it takes to complete 1 cycle
